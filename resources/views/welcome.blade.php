...
<head>
    ...
    <title>CFE - Comisión Federal de Electricidad</title>
...
<div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
    <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="https://laravel.com/assets/img/welcome/background.svg" alt="CFE background" />
    <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
        <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
            <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                <div class="flex lg:justify-center lg:col-start-2">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Logo_CFE.svg/1200px-Logo_CFE.svg.png" alt="CFE Logo" class="h-12 w-auto lg:h-16">
                </div>
                @if (Route::has('login'))
                ...
                <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                    ...
                    >
                        <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                            <img
                                src="https://www.cfe.mx/images/cfe-home.jpg"
                                alt="CFE Home"
                            ...
                            />
                            <img
                                src="https://www.cfe.mx/images/cfe-home-dark.jpg"
                                alt="CFE Home"
                        ...
                        <div class="relative flex items-center gap-6 lg:items-end">
                            <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                ...
                                <div class="pt-3 sm:pt-5 lg:pt-0">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">CFE - Comisión Federal de Electricidad</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        La Comisión Federal de Electricidad (CFE) es una empresa del Estado Mexicano que genera, transmite, distribuye y comercializa energía eléctrica para más de 40 millones de clientes en todo el país.
                                    </p>
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div class="pt-3 sm:pt-5">
                            <h2 class="text-xl font-semibold text-black dark:text-white">Tarifas de Electricidad</h2>

                            <p class="mt-4 text-sm/relaxed">
                                Consulta las tarifas de electricidad para los diferentes sectores: doméstico, industrial, comercial y agrícola. Conoce cómo se calcula tu consumo y cómo ahorrar energía.
                            </p>
                        </div>
                    ...
                    <a
                        href="https://www.cfe.mx/atencion-clientes"
                        class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                    >
                        <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                            <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><g fill="#FF2D20"><path d="M8.75 4.5H5.5c-.69 0-1.25.56-1.25 1.25v4.75c0 .69.56 1.25 1.25 1.25h3.25c.69 0 1.25-.56 1.25-1.25V5.75c0-.69-.56-1.25-1.25-1.25Z"/><path d="M24 10a3 3 0 0 0-3-3h-2V2.5a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2V20a3.5 3.5 0 0 0 3.5 3.5h19A3.5 3.5 0 0 0 24 20V10ZM3.5 21.5A1.5 1.5 0 0 1 2 20V3a.5.5 0 0 1 .5-.5h14a.5.5 0 0 1 .5.5v17c0 .295.037.588.11.874a.5.5 0 0 1-.484.625L3.5 21.5ZM22 20a1.5 1.5 0 1 1-3 0V9.5a.5.5 0 0 1 .5-.5H21a1 1 0 0 1 1 1v10Z"/><path d="M12.751 6.047h2a.75.75 0 0 1 .75.75v.5a.75.75 0 0 1-.75.75h-2A.75.75 0 0 1 12 7.3v-.5a.75.75 0 0 1 .751-.753ZM12.751 10.047h2a.75.75 0 0 1 .75.75v.5a.75.75 0 0 1-.75.75h-2A.75.75 0 0 1 12 11.3v-.5a.75.75 0 0 1 .751-.753ZM4.751 14.047h10a.75.75 0 0 1 .75.75v.5a.75.75 0 0 1-.75.75h-10A.75.75 0 0 1 4 15.3v-.5a.75.75 0 0 1 .751-.753ZM4.75 18.047h7.5a.75.75 0 0 1 .75.75v.5a.75.75 0 0 1-.75.75h-7.5A.75.75 0 0 1 4 19.3v-.5a.75.75 0 0 1 .75-.753Z"/></g></svg>
                        </div>

                        <div class="pt-3 sm:pt-5">
                            <h2 class="text-xl font-semibold text-black dark:text-white">Atención a Clientes</h2>

                            <p class="mt-4 text-sm/relaxed">
                                Encuentra información sobre cómo contactar a CFE, reportar fallas, solicitar servicios y realizar trámites en línea. Estamos para servirte.
                            </p>
                        </div>
                    ...
                    <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                        ...
                        <div class="pt-3 sm:pt-5">
                            <h2 class="text-xl font-semibold text-black dark:text-white">Servicios y Programas</h2>

                            <p class="mt-4 text-sm/relaxed">
                                CFE ofrece diversos servicios y programas para mejorar la eficiencia energética, como el programa de ahorro de energía, la instalación de medidores inteligentes y la promoción de energías renovables.
                            </p>
                        </div>
                    </div>
                </div>
